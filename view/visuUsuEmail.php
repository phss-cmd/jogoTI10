...
<div class="container mt-5">
  <form action="#" method="Post" class="row row-cols-auto justify-content-lg-center g-3 align-items-center">
    <div class="col-8">
      <label class="visually-hidden" for="inlineFormInputGroupUsername">Pesquisar por Email</label>
      <div class="input-group">
        <div class="input-group-text">Email</div>
        <input type="text" name="emailusu" class="form-control" id="inlineFormInputGroupUsername" placeholder="Pesquisar por Email">
      </div>
    </div>
    <div class="col-2">
...
<script>
  ...
  deletarUsuario.addEventListener('show.bs.modal', function(event) {
    ...
    modalbody.textContent = 'Gostaria Excluir o E-mail' + email + '?';
